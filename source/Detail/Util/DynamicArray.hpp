...
template <typename T>
constexpr typename DynamicArray<T>::iterator begin(DynamicArray<T>& arr) noexcept
{
    return arr.Begin();
}

template <typename T>
constexpr typename DynamicArray<T>::const_iterator begin(const DynamicArray<T>& arr) noexcept
{
    return arr.Begin();
}

template <typename T>
constexpr typename DynamicArray<T>::iterator end(DynamicArray<T>& arr) noexcept
{
    return arr.End();
}

template <typename T>
constexpr typename DynamicArray<T>::const_iterator end(const DynamicArray<T>& arr) noexcept
{
    return arr.End();
}

template <typename T>
constexpr typename DynamicArray<T>::reverse_iterator rbegin(DynamicArray<T>& arr) noexcept
{
    return arr.ReverseBegin();
}

template <typename T>
constexpr typename DynamicArray<T>::const_reverse_iterator rbegin(const DynamicArray<T>& arr) noexcept
{
    return arr.ReverseBegin();
}

template <typename T>
constexpr typename DynamicArray<T>::reverse_iterator rend(DynamicArray<T>& arr) noexcept
{
    return arr.ReverseEnd();
}

template <typename T>
constexpr typename DynamicArray<T>::const_reverse_iterator rend(const DynamicArray<T>& arr) noexcept
{
    return arr.ReverseEnd();
}

template <typename T>
constexpr typename DynamicArray<T>::const_iterator cbegin(const DynamicArray<T>& arr) noexcept
{
    return arr.Begin();
}

template <typename T>
constexpr typename DynamicArray<T>::const_iterator cend(const DynamicArray<T>& arr) noexcept
{
    return arr.End();
}

template <typename T>
constexpr typename DynamicArray<T>::const_reverse_iterator crbegin(const DynamicArray<T>& arr) noexcept
{
    return arr.ReverseBegin();
}

template <typename T>
constexpr typename DynamicArray<T>::const_reverse_iterator crend(const DynamicArray<T>& arr) noexcept
{
    return arr.ReverseEnd();
}
