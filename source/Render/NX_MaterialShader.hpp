...
public:
    ...
    /** Binding functions */
    void bindUniformBuffers(const gpu::Pipeline& pipeline, NX_ShadingMode shading, int dynamicRangeIndex);
...
inline void NX_MaterialShader::bindUniformBuffers(const gpu::Pipeline& pipeline, NX_ShadingMode shading, int dynamicRangeIndex)
{
