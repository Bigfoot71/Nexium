...
#define NX_INSTANCE_DATA_MATRIX     (1 << 0)    ///< Instance data contains transformation matrices (NX_Mat4).
#define NX_INSTANCE_DATA_COLOR      (1 << 1)    ///< Instance data contains colors (NX_Color).
#define NX_INSTANCE_DATA_CUSTOM     (1 << 2)    /**< Instance data contains custom vectors (NX_Vec4).\
