 ...
 */
HPAPI NX_RandGen* NX_CreateRandGen(uint64_t seed);
 ...
 */
HPAPI NX_RandGen NX_CreateRandGenTemp(uint64_t seed);
 ...
 */
HPAPI void NX_DestroyRandGen(NX_RandGen* generator);
 ...
 * @param seed 64-bit seed value
 */
HPAPI void NX_SetRandGenSeed(NX_RandGen* generator, uint64_t seed);
 ...
 */
HPAPI bool NX_RandBool(NX_RandGen* generator);
 ...
 */
HPAPI int32_t NX_RandInt(NX_RandGen* generator);
 ...
 */
HPAPI uint32_t NX_RandUint(NX_RandGen* generator);
 ...
 */
HPAPI float NX_RandFloat(NX_RandGen* generator);
 ...
 */
HPAPI int NX_RandRangeInt(NX_RandGen* generator, int min, int max);
 ...
 */
HPAPI uint32_t NX_RandRangeUint(NX_RandGen* generator, uint32_t min, uint32_t max);
 ...
 */
HPAPI float NX_RandRangeFloat(NX_RandGen* generator, float min, float max);
 ...
 */
HPAPI void NX_RandShuffle(NX_RandGen* generator, void* array, size_t element_size, size_t count);
